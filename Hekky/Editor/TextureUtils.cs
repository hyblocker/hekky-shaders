    ...
    public static class TextureUtils
    {
        ...
        public static Texture2D LoadTextureRAW(Texture2D original, string path) {
            ...
            if (path.EndsWith(".png") || path.EndsWith(".jpeg") || path.EndsWith(".jpg")) {
                Texture2D rawTexture = new Texture2D(original.width, original.height, TextureFormat.ARGB32, false, true);
        ...
        private static void ConvertNormalMap() {
            ...
            var computeShader = FetchComputeShaderByName(NormalMapComputeShaderName);
