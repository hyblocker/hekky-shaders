...
namespace Hekky
{
    ...
    public class PostProcessingGen : EditorWindow
    {
        ...
        static bool PostProcessingValidator()
        {
            ...
            return !(isPostProcessingAssetSetup && isScenePostProcessingSetup && PlayerSettings.colorSpace == ColorSpace.Linear);
#else
            return true;
#endif
        }
        ...
        void OnGUI() {
            ...
            if (PlayerSettings.colorSpace != ColorSpace.Linear) {
                EditorGUILayout.HelpBox("This project is not using linear colour space. PBR rendering requires linear colour space to function properly.", MessageType.Warning);
                GUILayout.Space(16);
            ...
            if (!isPostProcessingAssetSetup) {
                EditorGUILayout.HelpBox("Couldn't find a Post Processing asset in the current Unity Project.", MessageType.Warning);
                GUILayout.Space(16);
            ...
            if (isPostProcessingAssetSetup && isScenePostProcessingSetup && PlayerSettings.colorSpace == ColorSpace.Linear) {
                GUILayout.Label("Post Processing is set-up correctly!\n\n\nYou can close this window.", HGUI.LabelWordWrapCenter);
            }
#endif
        }
        ...
        static ScriptableObject GetPostProcessingAsset() {
            ...
            return assets.Length != 0 ? AssetDatabase.LoadAssetAtPath<ScriptableObject>(AssetDatabase.GUIDToAssetPath(assets[0])) : null;
        }
        ...
        void SetupScenePostProcessing(ScriptableObject postProcessingAsset) {
            ...
            if (candidatePostProcessingVolumes == null) {
                ...
                candidatePostProcessingVolumes = new[] {
                    postVolume
                };
            }
